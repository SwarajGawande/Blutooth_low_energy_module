...
#ifndef BLE_RADIO_ENERGY_MODEL_HELPER_H
#define BLE_RADIO_ENERGY_MODEL_HELPER_H
...
/**
 * \ingroup energy
 * \brief Assign BleRadioEnergyModel to Ble devices.
 *
 * This installer installs BleRadioEnergyModel for only BleNetDevice objects.
 *
 */
class BleRadioEnergyModelHelper : public DeviceEnergyModelHelper
{
public:
  /**
...
private:
  ...
  BleRadioEnergyModel::BleRadioEnergyDepletionCallback m_depletionCallback; ///< radio energy depletion callback
  BleRadioEnergyModel::BleRadioEnergyRechargedCallback m_rechargedCallback; ///< radio energy recharged callback
...
#endif /* Ble_RADIO_ENERGY_MODEL_HELPER_H */
