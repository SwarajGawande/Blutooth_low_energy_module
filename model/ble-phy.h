...
class SpectrumModel;
class NetDevice;
class BleRadioEnergyModel;
class BlePhyListener;
...
public:
  ...
  void RegisterListener (BlePhyListener *listener);
  /**
 ...
 /**
  ...
  void SetBleRadioEnergyModel (const Ptr<BleRadioEnergyModel> BleRadioEnergyModel);
...
private:
 ...
 Ptr<BleRadioEnergyModel> m_BleRadioEnergyModel;
 

 /**
   * typedef for a list of WifiPhyListeners
   */
  typedef std::vector<BlePhyListener *> Listeners;
  /**
   * typedef for a list of WifiPhyListeners iterator
   */
  typedef std::vector<BlePhyListener *>::iterator ListenersI;
