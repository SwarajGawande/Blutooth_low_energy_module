...
#ifndef BLE_TX_CURRENT_MODEL_H
#define BLE_TX_CURRENT_MODEL_H
 ...
 *
 */
class BleTxCurrentModel : public Object
{
public:
  /**
 ...
 * \ingroup energy
 *
 * \brief a linear model of the Ble transmit current
 *
 ...
 * "On the Effects of Transmit Power Control on the Energy Consumption of Ble Network Cards",
 ...
 *
 */
class LinearBleTxCurrentModel : public BleTxCurrentModel
{
public:
  /**
   * \brief Get the type ID.
  ...
  LinearBleTxCurrentModel ();
  virtual ~LinearBleTxCurrentModel ();
